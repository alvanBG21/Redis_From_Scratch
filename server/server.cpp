...
struct Conn
{
    ...
    Buffer outgoing; // response generated by the application
};
...
static Conn *handle_accept(int fd)
{
    ...
    Conn *conn = new Conn();
    conn->fd = connfd;
    conn->want_read = true; // ready to read immediately;
    return conn;
}
...
{
    // try parse the protocol: message header
...
// application callback when the socket is writeable
